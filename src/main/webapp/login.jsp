...
<header class="fb-header">
    <div class="inner-header">
        ...
        <form class="login-grid">
            ...
            <input class="email-input" type="text" name="text" id="email-phone">
            <label class="pass-label" for="password">Password</label>
            <input class="pass-input" type="password" name="password" id="password">
...
<main id="fb-main">
    <div class="fb-container">
        ...
        <section class="fb-form">
            ...
            <form class="sign-up" method="post" action="${pageContext.request.contextPath}/Signup.java">
                ...
                <div class="form-div">
                    ...
                    <div class="frm-radio">
                        <input type="radio" name="male-gender">
                        <label>Female</label>
                        <input type="radio" name="female-gender">
                        <label>Male</label>
                    </div>
